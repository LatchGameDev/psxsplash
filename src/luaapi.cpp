...
int LuaAPI::Random_Number(lua_State* L) {
    ...
    uint32_t value = SceneManager::m_random.number(max)+1;
...
int LuaAPI::Random_GeneratorNumber(lua_State* L) {
    ...
    uint32_t max = lua.toNumber(1);
    uint32_t value = SceneManager::m_randomGenerator.number(max)+1;
...
int LuaAPI::Random_Range(lua_State* L) {
    ...
    uint32_t value = SceneManager::m_random.number(difference+1) + min;
...
int LuaAPI::Random_GeneratorRange(lua_State* L) {
    ...
    uint32_t value = SceneManager::m_randomGenerator.number(difference+1) + min;
...
int LuaAPI::Random_GeneratorSeed(lua_State* L) {
    ...
    SceneManager::m_randomGenerator.seed(newSeed);
